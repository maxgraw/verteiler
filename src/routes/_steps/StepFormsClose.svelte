...
<Step num={5} title="Google Forms nach Deadline schließen" bind:open {ondone}>
    <StepContent>
        <ol>
            <li>Google Forms öffnen → Reiter Antworten.</li>
            <li>
                Den Schalter „Antworten möglich" umlegen, bis „Antworten werden
                nicht akzeptiert" erscheint.
            </li>
